    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.CharField(db_index=True, default=access.models.user.get_user_id, editable=False, max_length=8, unique=True, verbose_name='User ID')),
                ...
                ('avatar', models.URLField(blank=True, max_length=256, verbose_name='Image')),
