...
class {{#pascalCase}}{{name}}{{/pascalCase}}PaginatedListWidget extends BaseComponent {
  const {{#pascalCase}}{{name}}{{/pascalCase}}PaginatedListWidget({super.key});

  @override
  Widget body(BuildContext context, WidgetRef ref) {
    final provider = ref.read({{#camelCase}}{{name}}{{/camelCase}}PaginatedListProvider.notifier);
    final state = ref.watch({{#camelCase}}{{name}}{{/camelCase}}PaginatedListProvider);
