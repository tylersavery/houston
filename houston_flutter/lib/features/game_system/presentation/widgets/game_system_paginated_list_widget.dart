...
class GameSystemPaginatedListWidget extends BaseComponent {
  const GameSystemPaginatedListWidget({super.key});

  @override
  Widget body(BuildContext context, WidgetRef ref) {
    final provider = ref.read(gameSystemPaginatedListProvider.notifier);
    final state = ref.watch(gameSystemPaginatedListProvider);
